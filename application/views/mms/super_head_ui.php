...
<body>
    ...
    <div class="wrapper">
        <div class="section">
            ...
            <div id="main_div" style="padding: 30px; overflow-y: auto;">
               <?php 
                    if($active_nav == 1)
                        $this->load->view("mms/super_dashboard_ui"); //// pagtawag sa display sa daashboard
                    if($active_nav == 2)
                        $this->load->view("mms/super_user_ui");
                    if($active_nav == 3)
                        $this->load->view("mms/super_vendor_ui");
                    if($active_nav == 4)
                        $this->load->view('mms/super_sales_uploading_ui');
                    if($active_nav == 5)
                        $this->load->view('mms/super_uom_uploading_ui');
                    if($active_nav == 6)
                        $this->load->view("mms/super_report_ui");
                    if($active_nav == 7)
                        $this->load->view('mms/super_uom_uploading_ui_new_tab');     
                ?>
            </div>
        ...
        <div class="sidebar">
           ...
           <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                  <a class="<?php echo $active_nav == 1 ? 'selected' : '#';?>" href="<?php echo base_url('Super_ctrl/page/1');?>">
                    <i class="fas fa-tachometer-alt"></i> <span> Dashboard</span>
                  </a>
                </li>

                 <li>
                  <a class="<?php echo $active_nav == 2 ? 'selected' : '#';?>" href="<?php echo base_url('Super_ctrl/page/2');?>">
                    <i class="fa-solid fa-user"></i> <span> Users </span>
                  </a>
                </li>

                 <li>
                  <a class="<?php echo $active_nav == 3 ? 'selected' : '#';?>" href="<?php echo base_url('Super_ctrl/page/3');?>">
                    <i class="fas fa-store"></i> <span> Vendors </span>
                  </a>
                </li>

                  <li>
                  <a class="<?php echo $active_nav == 4 ? 'selected' : '#';?>" href="<?php echo base_url('Super_ctrl/page/4');?>">
                      <i class="fas fa-upload"></i> <span> Sales Uploading </span>
                  </a>
                </li>

                 <li>
                  <a class="<?php echo $active_nav == 5 ? 'selected' : '#';?>" href="<?php echo base_url('Super_ctrl/page/5');?>">
                     <i class="fas fa-upload"></i> <span> UOM Uploading </span>
                  </a>
                </li>

                 <li>
                  <a class="<?php echo $active_nav == 6 ? 'selected' : '#';?>" href="<?php echo base_url('Super_ctrl/page/6');?>">
                    <i class="fa fa-edit"></i> <span> Reports </span>
                  </a>
                </li>

                <li>
                    <a href="<?php echo base_url('Super_ctrl/logout');?>">
  ...
  <script>
            ...
            //   $.ajax({ 
            //             type:'POST',
            //             url:'<?php echo base_url('Super_ctrl/session_check_js'); ?>',
