...
class simplify extends CI_Model
{
    ...
    function populate_header_table($table_id,$header,$style_header)
    {       

       $html='
                <table id="'.$table_id.'" class="table table-striped table-bordered dataTable no-footer" style="background-color: rgb(0, 86, 137);">
                    <thead style="text-align: center;color:white;">
                        <tr>';
                                for($a=0;$a<count($header);$a++)
                                {
                                    $html.='<th style="text-align:center;'.$style_header[$a].'">'.$header[$a].'</th>';
                                }                    
